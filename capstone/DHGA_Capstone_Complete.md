...
This study, through Louvain community detection, reveals that the evolution of U.S. military technology is not a simple linear trajectory of progress but manifests three interrelated dynamics: technological convergence, technological learning, and technological rupture. Sections 4.6 and 3.5 extend that picture in two directions that the network analysis alone cannot reach: backward to the supply chain, and backward again to the analyst's interpretive apparatus. The discussion below integrates all four findings into a single interpretive frame, and reflects on what network analysis can—and cannot—do for the historiography of US military technology.

**5.1 Rupture and continuity, content and topology.** The most important theoretical implication of the project is that the rupture/continuity distinction depends on the *level of analysis* one chooses. At the level of weapons *content*, the AI/Drone cluster (Community 1) is genuinely discontinuous: Gorgon Stare, Switchblade, and LAWS do not extend the lineage of any prior US weapons community, and the modularity score of 0.5362 places them in a statistically independent cluster. At the level of supply chain *topology*, however, the 4.6 analysis shows the opposite: the structural pattern of US weapons delivery from 1776 to 2026 has been continuous, with only the geography of upstream production shifting (from Europe to Detroit to Taiwan/Korea). Methodologically, the lesson is that a network analysis of weapons alone produces a finding of rupture, while a network analysis of supply chains attached to those weapons produces a finding of continuity. Neither finding cancels the other; together they imply that US military technology is, simultaneously, undergoing its most significant paradigm shift in 75 years *and* reproducing the same political economy of arms production that has organized US military power since at least 1945. This simultaneity is what Sun Tzu, read in supply-chain terms, would call a positioning defeat already locked in: the US, in 2026, is winning the algorithmic arms race (rupture) while losing the structural arms race (continuity of dependency) at the same time.

**5.2 Network analysis as reflexive historiography.** Section 3.5 raised the methodological point that the Louvain algorithm does not generate interpretive labels for its own results, and that the analyst's vocabulary can reproduce US-centric framing even when the network is read against that framing. The project should be read, therefore, not as a final word on the structure of US military technology but as a partial view whose blind spots are themselves constitutive of the finding. The "Standalone" relabeling of Communities 4 and 5 (Section 3.5) is one such reflexive move: it is a public admission that the choice of "imperial" for one singleton and "NATO" for another was a labeling choice, not a network output. The non-Western reading of Section 4.6.2–4.6.3 (Sun Tzu, Mao) is another reflexive move: the same data set, when read through protracted-war doctrine rather than Clausewitzian friction, produces a substantively different strategic interpretation—one in which the AI supply chain chokepoint is a Maoist target rather than a Clausewitzian source of friction. Both moves demonstrate that digital history methods, when they are methodologically honest about their own interpretive apparatus, can produce a *more* critical history of military technology, not a less critical one. The cap on that claim is the limit of the dataset itself: 32 nodes and 41 edges, plus 17 supply-chain edges, are not enough to claim that the network is exhaustive. The findings are suggestive, not definitive.

**5.3 Civilian cost, profit, and the political economy of supply.** A theoretical contribution that the network analysis enables, but that a purely technical reading would obscure, is the integration of civilian cost and profit-driven inertia into a single analytical picture. Section 4.6.1 (Okinawa, Yokosuka, Guam, and the 1945 Battle of Okinawa) places the human cost of US weapons on the same map as the supply chain that delivers them, while Section 4.6.4 (Mỹ Lai) reads the small-arms communities of Section 4.3 as communities in which civilian harm has been a recurring structural feature. Section 4.6.5 (the military-industrial complex profit layer) then completes the picture by showing that the supply chain topology is a working product of a five-firm oligopoly whose structural incentives run against diversification. Read together, these sections support a theoretical claim that Eisenhower's 1961 warning (Eisenhower 1961) and Bacevich's analysis of post-1945 US militarism (Bacevich 2005) describe not historical anomalies but a normal feature of US weapons development in the modern period: the supply chain is, simultaneously, a strategic vulnerability, a humanitarian cost, and a profit center. Network analysis makes that triple structure visible in a way that a linear history cannot, because the supply chain edges of Section 4.6.1 are also revenue lines for Lockheed Martin, RTX, and Northrop Grumman, and they terminate at coordinates where 2.5 million people live. The weapons-history capstone, the AI-ethics capstone, and the political-economy capstone can therefore be written as one document, and the network diagram is the analytical instrument that makes the integration possible.

**5.4 What this study does not show.** A reflexive discussion must also note what the network cannot show. First, it cannot show whether the *operational* use of US weapons in the trans-Pacific theater has produced more or less civilian harm in 2026 than in 1945 or 1968; the dataset is a network of weapon systems, not a record of operational use. Second, it cannot resolve the question of whether AI weapons constitute a genuinely *new* category of military technology, or whether they are an extension of existing patterns (long-range precision strike, autonomous platforms, network-centric warfare); Community 1's statistical independence is suggestive but not definitive. Third, the 1776 and 1945 supply chain claims, as noted in Section 3.5, rest on secondary scholarship rather than direct NARA consultation, and are weaker than the 2026 claims. Each of these limitations is a candidate for a follow-up project: the integration of operational-use data, the addition of a finer-grained typology for AI weapon categories, and direct archival work on NARA Record Groups 93 and 156. The capstone as written is therefore a beginning, not an end; its most useful function is to identify the structural questions that digital history can productively ask, and to leave them productively open.

Taken together, the network analysis demonstrates that the influence of U.S. military technological evolution on trans-Pacific war outcomes is multidimensional and dynamic. Technological convergence brings competing powers' technical foundations closer together, technological learning accelerates iterative improvement, technological rupture foreshadows fundamental shifts in the character of warfare, and the supply chain and profit layer of Sections 4.6 and 3.5 reveal that beneath all of these surface dynamics is a structural continuity of dependency, civilian cost, and political economy that has organized US military power for 250 years. These insights not only enrich historical training but also provide empirical grounding for AI ethics discussions, and they reframe the historiography of US military technology in a way that a linear narrative cannot: as a network, not a lineage; as a supply chain, not a story; and as a contested political economy, not a national achievement.
...
*Word count: ~2,800 words (main body); ~3,100 words in Section 4.6; ~700 words in Section 3.5 (labeling and primary source limitations); ~1,400 words in Section 5 Discussion (5.1 rupture/continuity, 5.2 reflexive historiography, 5.3 civilian cost and profit, 5.4 limitations).*
